    ...
    public void trocarComUltimo(ArrayList<Jogador> jogador, int vez){
        ...
        if(ind2 == vez){
           ...
           System.out.println("Permanece no mesmo lugar por ja ser o ultimo.\n");
            ...
            int posUltimo = jogador.get(ind2).getPosicao();
            int posJogadorDaVez = jogador.get(vez).getPosicao();

            System.out.print("Trocou de lugar com o jogador ");
            System.out.print(jogador.get(ind2).getCor());
            System.out.println(".\n");

            jogador.get(vez).setPosicao(posUltimo);
            jogador.get(ind2).setPosicao(posJogadorDaVez);
        }

    }
    
    public void enviarInicio(ArrayList<Jogador> jogador, String cor){
